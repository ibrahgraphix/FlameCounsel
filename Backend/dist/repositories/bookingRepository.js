...
exports.bookingRepository = {
    ...
    async rescheduleBooking(bookingId, bookingDate, bookingTime) {
       ...
       WHERE booking_id = $3
       RETURNING booking_id, student_id, counselor_id, booking_date, booking_time, year_level, additional_notes, status, created_at, updated_at`, [bookingDate, bookingTime, bookingId]);
        if (!res.rows || res.rows.length === 0)
            return null;
        return res.rows[0];
    },
