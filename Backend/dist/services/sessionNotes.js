...
exports.lookupStudentById = exports.getNotesByCounselor = exports.createSessionNote = void 0;
// src/services/sessionNotes.ts
const repo = __importStar(require("../repositories/sessionNotes"));
...
const getNotesByCounselor = async (counselor_id) => {
    return await repo.findByCounselor(counselor_id);
};
exports.getNotesByCounselor = getNotesByCounselor;
/**
 * Expose student check so controller can reuse repository logic
 */
const lookupStudentById = async (student_id) => {
    return await repo.getStudentById(student_id);
};
exports.lookupStudentById = lookupStudentById;
